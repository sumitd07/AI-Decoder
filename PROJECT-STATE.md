...
- **58 terms** (33 agentic/LLM-ops + a 25-term foundational layer added 2026-07-29: genai, machinelearning, deeplearning, neuralnetwork, prompt, llm, transformer, gpt, chatgpt, gan, diffusion, dalle, texttoimage, parameters, trainingdata, inference, supervised, unsupervised, reinforcementlearning, rlhf, overfitting, backprop, pretraining, foundationmodel, multimodal). The foundational batch fixed a real coverage gap — intro articles like "GANs to GPT-4" previously highlighted nothing.
